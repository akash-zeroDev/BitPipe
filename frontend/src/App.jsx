            ...
            {queue.length > 0 && (
              ...
              {batchStatus === 'processing' ? (
                ...
                <button
                  ...
                  className="w-full py-4 bg-gray-950 hover:bg-black disabled:opacity-50 disabled:cursor-not-allowed rounded-xl font-bold text-white flex items-center justify-center gap-2 transition shadow-lg"
                >
                  <Download size={20} />
                  Download All as ZIP
                </button>
                  ...
                  <div className="flex flex-col w-full">
                    ...
                    <div className="grid grid-cols-2 gap-6 w-full mt-8">
                      <div className="bg-slate-100 rounded-2xl p-6 flex flex-col items-center justify-center shadow-lg border border-slate-200">
                        ...
                        <span className="text-4xl font-extrabold text-gray-900 tracking-tight">{getCalculatedVideoCount()}</span>
                      </div>
                      <div className="bg-slate-100 rounded-2xl p-6 flex flex-col items-center justify-center shadow-lg border border-slate-200">
                        <span className="text-xs text-gray-500 font-bold uppercase tracking-widest mb-1">Total Time</span>
                        <span className="text-4xl font-extrabold text-gray-900 tracking-tight">{formatDuration(getCalculatedDuration())}</span>
                      </div>
                    </div>
